...
arguments. The `diag.panel` can be set to set the plots along the
diagonal. The upper and lower panels are set by a function with
signature `function(x, y, ...)` while the diagonal panel is controled
by a function with signature `function(x, ...)`.
