...
The `Biocpkg("pRoloc")` package offers dedicated functionality to
manipulate, annotate, analyse and visualise spatial proteomics
data. Its companion package `Biocpkg("pRolocGUI")` offers support for
interactive visualisation.
...
application](https://lgatto.shinyapps.io/christoforou2015/):

```{r pRolocGUI, echo = FALSE}
knitr::include_app("https://lgatto.shinyapps.io/christoforou2015/",
				   height = "650px")
```
